...
CREATE TABLE "new_Item" (
    ...
    "priceStandalone" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Item" ("breakoutGroupId", "drawingRef", "fabMarkup", "id", "itemName", "itemNumber", "materialMarkup", "projectId", "sortOrder") SELECT "breakoutGroupId", "drawingRef", "fabMarkup", "id", "itemName", "itemNumber", "materialMarkup", "projectId", "sortOrder" FROM "Item";
DROP TABLE "Item";
...
INSERT INTO "new_Project" ("architect", "bidAmount", "bidDate", "bidTime", "billingAddress", "createdAt", "createdById", "customerContact", "customerEmail", "customerId", "customerName", "customerPhone", "dashboardStatus", "deliveryFobJobsite", "deliveryInstalled", "deliveryWillCall", "description", "drawingDate", "drawingRevision", "estimateDate", "estimatedBy", "estimatorId", "id", "isArchived", "newOrCo", "notes", "parentProjectId", "projectAddress", "projectName", "publishedAt", "publishedById", "startDate", "status", "taxCategory", "typeMiscellaneous", "typeOrnamental", "typeStructural", "updatedAt") SELECT "architect", "bidAmount", "bidDate", "bidTime", "billingAddress", "createdAt", "createdById", "customerContact", "customerEmail", "customerId", "customerName", "customerPhone", "dashboardStatus", "deliveryFobJobsite", "deliveryInstalled", "deliveryWillCall", "description", "drawingDate", "drawingRevision", "estimateDate", "estimatedBy", "estimatorId", "id", "isArchived", "newOrCo", "notes", "parentProjectId", "projectAddress", "projectName", "publishedAt", "publishedById", "startDate", "status", "taxCategory", "typeMiscellaneous", "typeOrnamental", "typeStructural", "updatedAt" FROM "Project";
DROP TABLE "Project";
