...
INSERT INTO "new_ChildMaterial" ("category", "description", "fabWeight", "galvRate", "galvanized", "id", "length", "parentId", "pieces", "pricePerFt", "pricePerLb", "shape", "sortOrder", "stockLength", "stockWeight", "stocksRequired", "thickness", "totalCost", "waste", "weightPerFt", "width") SELECT "category", "description", "fabWeight", "galvRate", "galvanized", "id", "length", "parentId", "pieces", "pricePerFt", "pricePerLb", "shape", "sortOrder", "stockLength", "stockWeight", "stocksRequired", "thickness", "totalCost", "waste", "weightPerFt", "width" FROM "ChildMaterial";
