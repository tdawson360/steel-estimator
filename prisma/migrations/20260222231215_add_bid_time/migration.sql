...
INSERT INTO "new_Project" ("architect", "bidAmount", "bidDate", "billingAddress", "createdAt", "createdById", "customerContact", "customerEmail", "customerName", "customerPhone", "dashboardStatus", "deliveryFobJobsite", "deliveryInstalled", "deliveryWillCall", "description", "drawingDate", "drawingRevision", "estimateDate", "estimatedBy", "estimatorId", "id", "isArchived", "newOrCo", "notes", "parentProjectId", "projectAddress", "projectName", "publishedAt", "publishedById", "startDate", "status", "taxCategory", "typeMiscellaneous", "typeOrnamental", "typeStructural", "updatedAt") SELECT "architect", "bidAmount", "bidDate", "billingAddress", "createdAt", "createdById", "customerContact", "customerEmail", "customerName", "customerPhone", "dashboardStatus", "deliveryFobJobsite", "deliveryInstalled", "deliveryWillCall", "description", "drawingDate", "drawingRevision", "estimateDate", "estimatedBy", "estimatorId", "id", "isArchived", "newOrCo", "notes", "parentProjectId", "projectAddress", "projectName", "publishedAt", "publishedById", "startDate", "status", "taxCategory", "typeMiscellaneous", "typeOrnamental", "typeStructural", "updatedAt" FROM "Project";
DROP TABLE "Project";
