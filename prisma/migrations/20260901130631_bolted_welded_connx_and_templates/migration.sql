-- AlterTable
ALTER TABLE "ConnectionCategory" ADD COLUMN "boltedConnxCost" REAL;
ALTER TABLE "ConnectionCategory" ADD COLUMN "boltedSyncedAt" DATETIME;
ALTER TABLE "ConnectionCategory" ADD COLUMN "boltedTemplateItemId" INTEGER;
ALTER TABLE "ConnectionCategory" ADD COLUMN "weldedConnxCost" REAL;
ALTER TABLE "ConnectionCategory" ADD COLUMN "weldedSyncedAt" DATETIME;
ALTER TABLE "ConnectionCategory" ADD COLUMN "weldedTemplateItemId" INTEGER;
...
INSERT INTO "new_Project" ("architect", "bidAmount", "bidDate", "bidTime", "billingAddress", "createdAt", "createdById", "customerContact", "customerEmail", "customerId", "customerName", "customerPhone", "dashboardStatus", "deliveryFobJobsite", "deliveryInstalled", "deliveryWillCall", "description", "drawingDate", "drawingRevision", "estimateDate", "estimatedBy", "estimatorId", "id", "isArchived", "nestEndCropIn", "nestKerfIn", "nestingEnabled", "newOrCo", "notes", "parentProjectId", "projectAddress", "projectName", "publishedAt", "publishedById", "startDate", "status", "stockLengthOverrides", "taxCategory", "typeMiscellaneous", "typeOrnamental", "typeStructural", "updatedAt") SELECT "architect", "bidAmount", "bidDate", "bidTime", "billingAddress", "createdAt", "createdById", "customerContact", "customerEmail", "customerId", "customerName", "customerPhone", "dashboardStatus", "deliveryFobJobsite", "deliveryInstalled", "deliveryWillCall", "description", "drawingDate", "drawingRevision", "estimateDate", "estimatedBy", "estimatorId", "id", "isArchived", "nestEndCropIn", "nestKerfIn", "nestingEnabled", "newOrCo", "notes", "parentProjectId", "projectAddress", "projectName", "publishedAt", "publishedById", "startDate", "status", "stockLengthOverrides", "taxCategory", "typeMiscellaneous", "typeOrnamental", "typeStructural", "updatedAt" FROM "Project";
DROP TABLE "Project";
