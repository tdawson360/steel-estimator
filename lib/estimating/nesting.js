...
//
// Plate is 2D sheet stock, Custom lines have no reliable size key, and
// Hardware is bought per each — none of them pool.
const NEST_EXCLUDED_CATEGORIES = new Set(['Plate', 'Custom', 'Hardware']);
